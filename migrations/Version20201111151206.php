 ...
 */
final class Version20201111151206 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ville ADD contact_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE ville ADD CONSTRAINT FK_43C3D9C3E7A1254A FOREIGN KEY (contact_id) REFERENCES users (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_43C3D9C3E7A1254A ON ville (contact_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_43C3D9C3E7A1254A ON ville');
        $this->addSql('ALTER TABLE ville DROP contact_id');
    }
}
