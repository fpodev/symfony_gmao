 ...
 */
final class Version20200729151247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE name name VARCHAR(180) NOT NULL, CHANGE firstname firstname VARCHAR(100) NOT NULL, CHANGE email email VARCHAR(100) NOT NULL, CHANGE role roles JSON NOT NULL');
